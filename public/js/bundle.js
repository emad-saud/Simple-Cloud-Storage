      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "http://".concat(location.host, "/api/users/login"),
            data: {
              email: email,
              password: password
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"sendFile.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var sendFile = exports.sendFile = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "http://".concat(location.host, "/api/files/upload"),
            data: data
          });
        case 3:
          res = _context.sent;
          if (res.data.status === "success") (0, _alerts.showAlert)("success", "file uploaded successfully!");
          window.location.assign("/");
          _context.next = 11;
          break;
        case 8:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "http://".concat(location.host, "/api/users/sign-up"),
            data: {
              name: name,
              email: email,
              password: password,
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', 'could not sign up');
        case 11:
        case "end":
          return _context.stop();
      }
